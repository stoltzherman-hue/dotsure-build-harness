  ...
  return (
    <div className="content">
      <div className="page-head">
        <div><h1>Compliance assessments</h1><p>SA insurance regulatory framework — 8 domains assessed per project</p></div>
      </div>
      ...
      {loading ? <div className="empty">Loading...</div> : projects.length === 0 ? (
        <div className="empty" style={{background:"var(--wh)",border:"1px solid var(--g100)",borderRadius:10,padding:40}}>
          Register a project first — compliance assessments are generated automatically
        </div>
      ) : projects.map(p => {
